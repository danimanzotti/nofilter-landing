export default {
  ...
  featuresQuantity:
    "NoFilter bevat <1>5000 spots</1> over de hele wereld en er worden wekelijks ongeveer <1>100 nieuwe foto's toegevoegd</1>",
  ...
  'Show me some examples near me!': 'Toon mij enkele voorbeelden bij mij in de buurt!',
  'Some examples': 'Een paar voorbeelden',
  titleInstagrammers:
    'Voor <1>instagrammers</1> die de beste <1>fotoshoot</1> locaties willen ontdekken',
  titlePhotographers:
    'Voor <1>fotografen</1> die de beste fotoplekken <1>in de buurt</1> willen ontdekken',
  titleTravelers:
