export default {
  ...
  featuresQuantity:
    'NoFilter zawiera <1>5000 miejsc</1> na całym świecie, a około <1>co tydzień dodaje się 100 nowych zdjęć</1>',
  ...
  Quality: 'Jakość',
  Quantity: 'Ilość',
  'Show me some examples near me!': 'Pokaż mi kilka przykładów blisko mnie!',
  'Some examples': 'Kilka przykładów',
  titleInstagrammers:
    'Dla <1>instagrammerów</1>, którzy chcą odkryć najlepsze lokalizacje <1>sesji zdjęciowej</1>',
  titlePhotographers:
    'Dla <1>fotografów</1>, którzy chcą odkryć najlepsze miejsca na zdjęcia <1>w pobliżu</1>',
  titleTravelers:
