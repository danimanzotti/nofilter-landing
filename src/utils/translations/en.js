export default {
  ...
  featuresQuantity:
    'NoFilter contains <1>5,000 spots</1> around the world, and around <1>100 new photos are added every week</1>',
  ...
  Quality: 'Quality',
  Quantity: 'Quantity',
  'Show me some examples near me!': 'Show me some examples near me!',
  'Some examples': 'Some examples',
  titleInstagrammers:
    'For <1>instagrammers</1> who want to discover the best <1>photoshoot</1> locations',
  titlePhotographers:
    'For <1>photographers</1> who want to discover the best photo spots <1>nearby</1>',
  titleTravelers:
    'For <1>travelers</1> who want to discover the best photo spots <1>around the world</1>',
