export default {
  ...
  featuresQuantity:
    'O NoFilter contém <1> 3.500 spots </1> em todo o mundo e cerca de <1> 30 novas fotos são adicionadas a cada semana </1>',
  featuresPrice:
    'Ah ... Sim ... E é <1> gratuito </1> e está disponível para <1> Android e iOS </1>',
  'Geolocation is not supported by this browser':
    'A localização geográfica não é suportada por este navegador',
  'Getting spots...': 'Obtendo pontos ...',
  ...
  Quality: 'Qualidade',
  Quantity: 'Quantidade',
  'Show me some examples near me!': 'Mostre-me alguns exemplos perto de mim!',
  'Some examples': 'Alguns exemplos',
  titleInstagrammers:
    'Para <1> instagrammers </1> que desejam descobrir os melhores locais <1> photoshoot </1>',
  titlePhotographers:
    'Para <1> fotógrafos </1> que desejam descobrir os melhores pontos de foto <1> nas proximidades </1>',
  titleTravelers:
    'Para <1> viajantes </1> que desejam descobrir os melhores pontos de fotos <1> ao redor do mundo </1>',
