export default {
  ...
  Quality: 'Kualitas',
  Quantity: 'Kuantitas',
  'Show me some examples near me!': 'Tunjukkan pada saya beberapa contoh di dekat saya!',
  'Some examples': 'Beberapa contoh',
  titleInstagrammers:
    'Untuk <1> instagrammers </1> yang ingin menemukan lokasi <1> pemotretan </1> terbaik',
  titlePhotographers:
    'Untuk <1> fotografer </1> yang ingin menemukan tempat foto terbaik <1> terdekat </1>',
  titleTravelers:
    'Untuk <1> pelancong </1> yang ingin menemukan tempat foto terbaik <1> di seluruh dunia </1>',
