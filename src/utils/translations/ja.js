export default {
  ...
  Quality: '品質',
  Quantity: '量',
  'Show me some examples near me!': '近くの例を見せてください！',
  'Some examples': 'いくつかの例',
  titleInstagrammers: '最高の<1>写真撮影</ 1>の場所を発見したい<1>インスタグラマー</ 1>',
  titlePhotographers: '<1>近く</ 1>の最高の写真スポットを発見したい<1>写真家</ 1>のために',
