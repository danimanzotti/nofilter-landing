export default {
  ...
  featuresQuantity:
    'NoFilter conté <1>5.000 llocs</1> arreu del món, i al voltant de <1>100 fotos noves s’afegeixen cada setmana</1>',
  ...
  Quality: 'Qualitat',
  Quantity: 'Quantitat',
  'Show me some examples near me!': "Mostra'm alguns exemples a prop meu!",
  'Some examples': 'Alguns exemples',
  titleInstagrammers:
    'Per <1>instagrammers</1> que vulguin descobrir les millors ubicacions de <1>fotoshoot</1>',
  titlePhotographers:
    'Per als <1>fotògrafs</1> que vulguin descobrir els millors llocs fotogràfics <1>a prop</1>',
  titleTravelers:
    'Per als <1>viatgers</1> que vulguin descobrir els millors llocs fotogràfics <1>arreu del món</1>',
