export default {
  ...
  Quality: 'Gæði',
  Quantity: 'Magn',
  'Show me some examples near me!': 'Sýndu mér nokkur dæmi nálægt mér!',
  'Some examples': 'Nokkur dæmi',
  titleInstagrammers:
    'Fyrir <1> skipuleggjendur </1> sem vilja uppgötva bestu <1> ljósmyndir </1> staðina',
  titlePhotographers:
    'Fyrir <1> ljósmyndara </1> sem vilja uppgötva bestu ljósmyndabletti <1> nálægt </1>',
  titleTravelers:
