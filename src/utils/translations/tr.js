export default {
  ...
  titlePhotographers:
    'En iyi <1>fotoğraf</1> noktalarını keşfetmek isteyen <1>fotoğrafçılar için yakınında</1>',
  titleTravelers:
    '<1>Dünyanın dört bir yanındaki</1> en iyi fotoğraf noktalarını keşfetmek isteyen <1>gezginler</1> için',
