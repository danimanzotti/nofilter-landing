export default {
  ...
  Quality: 'Kualiti',
  Quantity: 'Kuantiti',
  'Show me some examples near me!': 'Tunjukkan beberapa contoh berhampiran saya!',
  'Some examples': 'Beberapa contoh',
  titleInstagrammers:
    'Bagi <1> instagrammers </1> yang ingin menemui <1> lokasi pemotretan </1> terbaik',
  titlePhotographers:
    'Bagi <1> jurugambar </1> yang ingin menemui tempat foto terbaik <1> berdekatan </1>',
  titleTravelers:
