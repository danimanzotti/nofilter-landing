...
const TermsOfUse = () => {
  return (
    <div className="content-wrapper terms-of-use legal">
      <h1>Terms and Conditions</h1>

      <p>Last updated: January 07, 2019</p>

      <p>
        These Terms and Conditions ("Terms", "Terms and Conditions") govern your relationship with
        https://getnofilter.com/ website and NoFilter mobile application (the "Service") operated by
        NoFilter ("us", "we", or "our").
      </p>

      <p>
        Please read these Terms and Conditions carefully before using our website and NoFilter
      ...
      <p>
        ...
        same conditions unless you cancel it or NoFilter cancels it. You may cancel your
        Subscription renewal either through your online account management page or by contacting
        NoFilter customer support team.
      </p>

      <p>
        A valid payment method, including credit card or PayPal, is required to process the payment
        for your Subscription. You shall provide NoFilter with accurate and complete billing
        ...
        authorize NoFilter to charge all Subscription fees incurred through your account to any such
        payment instruments.
      </p>

      <p>
        Should automatic billing fail to occur for any reason, NoFilter will issue an electronic
      ...
      <p>
        NoFilter, in its sole discretion and at any time, may modify the Subscription fees for the
        Subscriptions. Any Subscription fee change will become effective at the end of the
        then-current Billing Cycle.
      </p>

      <p>
        NoFilter will provide you with a reasonable prior notice of any change in Subscription fees
      ...
      <p>
        Certain refund requests for Subscriptions may be considered by NoFilter on a case-by-case
        basis and granted in sole discretion of NoFilter.
      </p>
      ...
      <p>
        ...
        "Copyright Infringement" of hello@no-filter.app and include in your notice a detailed
      ...
      <p>
        ...
        functionality are and will remain the exclusive property of NoFilter and its licensors. The
        ...
        product or service without the prior written consent of NoFilter.
      </p>
      ...
      <p>
        ...
        controlled by NoFilter.
      </p>

      <p>
        NoFilter has no control over, and assumes no responsibility for, the content, privacy
        policies, or practices of any third party web sites or services. You further acknowledge and
        agree that NoFilter shall not be responsible or liable, directly or indirectly, for any
      ...
      <p>
        In no event shall NoFilter, nor its directors, employees, partners, agents, suppliers, or
      ...
      <p>
        NoFilter its subsidiaries, affiliates, and its licensors do not warrant that a) the Service
