...
const PrivacyPolicy = () => {
  return (
    <div className="content-wrapper privacy-policy legal">
      <h1>Privacy Policy</h1>

      <p>Effective date: January 07, 2019</p>

      <p>
        NoFilter ("us", "we", or "our") operates the https://getnofilter.com/ website and the
        NoFilter mobile application (hereinafter referred to as the "Service").
      </p>
      ...
      <ul>
        <li>
          ...
          <p>
            Service means the https://getnofilter.com/ website and the NoFilter mobile application
            operated by NoFilter
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        When you access the Service with a mobile device, this Usage Data may include information
      ...
      <h2>Use of Data</h2>
      <p>NoFilter uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        If you are from the European Economic Area (EEA), NoFilter legal basis for collecting and
      ...
      <p>NoFilter may process your Personal Data because:</p>
      <ul>
      ...
      <p>
        NoFilter will retain your Personal Data only for as long as is necessary for the purposes
      ...
      <p>
        NoFilter will also retain Usage Data for internal analysis purposes. Usage Data is generally
      ...
      <p>
        If you are located outside Argentina and choose to provide information to us, please note
        that we transfer the data, including Personal Data, to Argentina and process it there.
      </p>
      <p>
      ...
      <p>
        NoFilter will take all the steps reasonably necessary to ensure that your data is treated
      ...
      <p>
        If NoFilter is involved in a merger, acquisition or asset sale, your Personal Data may be
      ...
      <p>
        Under certain circumstances, NoFilter may be required to disclose your Personal Data if
      ...
      <p>
        NoFilter may disclose your Personal Data in the good faith belief that such action is
        necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of NoFilter</li>
      ...
      <p>
        ...
        rights. NoFilter aims to take reasonable steps to allow you to correct, amend, delete or
      ...
      <ul>
        <li>
          <p>
            ...
            directly within your account settings section. If you are unable to perform these
            actions yourself, please contact us to assist you.
          </p>
        </li>
        <li>
          <p>
            <strong>The right of rectification.</strong> You have the right to have your information
            rectified if that information is inaccurate or incomplete.
          </p>
        </li>
        <li>
          <p>
            <strong>The right to object.</strong> You have the right to object to our processing of
            your Personal Data.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>The right to data portability.</strong> You have the right to be provided with a
            copy of the information we have on you in a structured, machine-readable and commonly
            used format.
          </p>
        </li>
        <li>
          <p>
            ...
            consent at any time where NoFilter relied on your consent to process your personal
            information.
          </p>
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            Amplitude, Inc. is a cloud-based product-analytics platform that helps customers build
            better products.
          </p>
          <p>
            For more information on what type of information Amplitude collects, please visit the
            Amplitude Privacy web page:{' '}
      ...
      <ul>
        <li>
          By email: <a href="mailto:hello@no-filter.app">hello@no-filter.app</a>
        </li>
        <li>
          By visiting this page on our website:{' '}
          <Link to="/contact">https://getnofilter.com/contact</Link>
        </li>
      </ul>
    </div>
  );
